...
class Storage
{
    ...
    )
    {
        ...
        if ($this->_credentials === null) {
            $this->_credentials = new Credentials\SharedKey(
                $this->_accountName, $this->_accountKey, $this->_usePathStyleUri, $isAccountKeyBase64encoded
            );
        }
    ...
    )
    {
        ...
        $sasGenerator = new Credentials\SharedAccessSignatureGenerator();
        $request = $sasGenerator->generateRequestObject($httpVerb, $requestUrl, $this->_accountName , $this->_accountKey, time()+300);
